...
class CaretakerMedicinesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final caretakerId = auth.currentUser?.uid ?? '';

    // If no patient selected, try to auto-select the first linked patient
    if (patientId == null || patientId!.isEmpty) {
      return StreamBuilder<List<LinkedPatient>>(
        ...
        builder: (context, snapshot) {
          ...
          return _PatientMedicinesView(patientId: patients.first.uid);
        },
      );
    }
        ...
        child: GlassCard(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Go to the Patients tab to link your first patient.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14,
